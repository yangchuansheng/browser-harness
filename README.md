...
| [`dinoallo/browser-harness`](https://github.com/dinoallo/browser-harness) (this repo) | Rust daemon + runner + CLI + guest runtime | You want the harness idea, but as a durable systems runtime with stable operations and a WASM path | Heavier than the original Python harness, less raw than the JS variant |
...
```text
Set up https://github.com/dinoallo/browser-harness.git for me.
